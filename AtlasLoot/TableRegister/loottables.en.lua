...
------------
  ...
  -- Heroic Incentive Token
	AtlasLoot_TableNames["IncentiveTokens1"] = { AL["Heroic Incentive Token Rewards"], "AtlasLootWotLK" };
	AtlasLoot_TableNames["IncentiveTokens2"] = { AL["Incentive Token Rewards"], "AtlasLootWotLK" };
	AtlasLoot_TableNames["IncentiveTokens3"] = { AL["Incentive Token Rewards"], "AtlasLootWotLK" };
...
-------------
  ...
  -- Menus, the entry does nothing, but makes the generalised loot table code less complex
	...
	AtlasLoot_TableNames["INCENTIVETOKENMENU"] = { AL["Incentive Token Rewards"], "Menu" };
